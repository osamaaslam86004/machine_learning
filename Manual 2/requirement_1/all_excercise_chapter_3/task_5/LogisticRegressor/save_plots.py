...
def plot_precision_recall_vs_threshold(y_true, y_scores):
    ...
    plt.grid(True)
    plt.savefig(
        "LogisticRegression_roc_curve_precision_recall_vs_threshold.png"
    )  # Save the plot
    plt.show()
...
def plot_precision_vs_recall(precisions, recalls):
    ...
    plt.grid(True)
    plt.savefig("LogisticRegression_roc_curve_precision_vs_recall.png")  # Save the plot
    plt.show()
...
def plot_roc_curve(fpr, tpr, auc):
    ...
    plt.title("ROC Curve")
    plt.legend()
    plt.savefig("LogisticRegression_roc_curve.png")
    plt.show()

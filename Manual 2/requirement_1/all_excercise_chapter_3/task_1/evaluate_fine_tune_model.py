...
def plot_confusion_matrix(y_true, y_pred, classes):
    ...
    plt.savefig("fine-tune_KNN_confusion_matrix.png")  # Saves the figure
    plt.show()


def evaluate_fine_tune_model(best_fine_tune_model, X_test, y_test):
    """
    Evaluates the performance of a fine-tune model on a test dataset.
    ...
    y_pred = best_fine_tune_model.predict(X_test)
    end_time = time.time()

...
model_path = os.path.join(
    r"D:\Machine learning\Arch technologhy\Manual 2\requirement_1\MNIST Digit Recognition Project\results_SGClassifier\step_2_yes_aug_no_hog\best_fine_tune_sgd.joblib"
)


# Load the model from the specified path
scaler_path = os.path.join(
    r"D:\Machine learning\Arch technologhy\Manual 2\requirement_1\MNIST Digit Recognition Project\results_SGClassifier\step_2_yes_aug_no_hog\scaler.joblib"
)
...
try:
    ...
    # Update loaded scaler
    scaler = joblib.load(scaler_path)
    print(f"Scaler loaded from {scaler_path}")

except FileNotFoundError:
    print(
        f"No pre-trained model found at {model_path} or scaler at {scaler_path}. Using a default initialized SGDClassifier."
    )
